class PurchaseOrdersController < ApplicationController
  ...
  def create
    ...
    if @purchase_order.save
      redirect_to @purchase_order, notice: "PurchaseOrder creado con éxito."
    else
  ...
  def update
    ...
    if @purchase_order.update(purchase_order_params)
      redirect_to @purchase_order, notice: "Actualizado con éxito."
    else
  ...
  def destroy
    ...
    redirect_to products_url, notice: "purchase_order eliminado con éxito.", status: :see_other
  end
